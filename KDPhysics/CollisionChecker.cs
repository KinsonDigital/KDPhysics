...
namespace KDPhysics
{
    public static class CollisionChecker
    {
        ...
        public static CollisionResult PolygonCollision(Polygon polygonA, Polygon polygonB, Vect2 velocity)
        {
            ...
            for (var edgeIndex = 0; edgeIndex < edgeCountA + edgeCountB; edgeIndex++)
            {
                ...
                var velocityProjection = PMath.DotProduct(axis, velocity);
                ...
                if (intervalDistance < minIntervalDistance)
                {
                    ...
                    var d = polygonA.Position - polygonB.Position;
